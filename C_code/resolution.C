//This is a code to determine the resolution in simulation of the rigitidity, beta, and mass dependence of HELIX instrument
// R=pc/Ze
...
// declare histograms of true CRs
  ...
  TH1D *hMass_true= new TH1D("Mass Identification Histogram of True CRs", "Mass Identification Histogram", 100, 0, 20);
  TGraph *g_Rigid_Beta_true;
// Open a file to save the data
  TFile *file_out = new TFile("resolution_output.root","RECREATE");
...
// declare histograms of observed quantities
  ...
  TH1D *hMass_observed= new TH1D("Mass Identification Histogram", "Mass Identification Histogram", 100, 0, 20);
