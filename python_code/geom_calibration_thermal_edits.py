...
def plot_ratio(seq):
    ...
    while j < 3:
       ...
       j+=1
    #do the binning using find_avg_errors function
    ...
    while j>=5:
       ...
       j=j/2
#    bins10, avg10, errors10=find_avg_errors(lvl_refined[0],lvl_refined[1],lvl_refined[2],ratio_refined[0],ratio_refined[1],ratio_refined[2],10)
#    bins20, avg20, errors20=find_avg_errors(lvl_refined[0],lvl_refined[1],lvl_refined[2],ratio_refined[0],ratio_refined[1],ratio_refined[2],20)
#    bins40, avg40, errors40=find_avg_errors(lvl_refined[0],lvl_refined[1],lvl_refined[2],ratio_refined[0],ratio_refined[1],ratio_refined[2],40)
    # fitting section
    #       print("{} is array bins".format(bins40))
    #       print("{} is array avg".format(avg40))
 #   p40, res40, rank40, single40,rcond40=numpy.polyfit(bins40, avg40, 0, full=True)
...
#    fig=plt.figure(figsize=(14, 14), dpi=800)
    ...
    #declare constants for figure and arrays for plotting
    ...
    while j <= 3:
       ...
       j=j+1
#    plt.setp(ax_40.get_xticklabels(), visible=False)
#    ax_40.set_title('Ratio vs Level, Binned',fontsize=fntsz)
#    ax_40.errorbar(bins40, avg40, errors40, linestyle='None', marker='^', elinewidth=size_of_marker, color='r',label=plot_name40)
#    ax_40.axhline(pvals40(50), color='black', lw=width_of_line)
#    ax_40.legend(loc='upper right',fontsize=fntsz)
#    ax_20=plt.subplot(412,sharex=ax_40, sharey=ax_40)
#    plt.setp(ax_20.get_xticklabels(), visible=False)
#    ax_20.errorbar(bins20, avg20, errors20, linestyle='None', marker='^', capsize=size_of_marker, color='b',label=plot_name20)
#    ax_20.axhline(pvals20(50), color='black', lw=width_of_line)
    #     ax_40.set_ylabel('Ratio (meters squared)')
#    ax_20.legend(loc='upper right',fontsize=fntsz)
#    ax_10=plt.subplot(413,sharex=ax_40,sharey=ax_40)
#    plt.setp(ax_10.get_xticklabels(), visible=False)
#    ax_10.errorbar(bins10, avg10, errors10, linestyle='None', marker='^', capsize=size_of_marker, color='g',label=plot_name10)
#    ax_10.axhline(pvals10(50), color='black', lw=width_of_line)
#    ax_10.set_ylabel('Ratio (meters squared)',fontsize=fntsz)
#    ax_10.legend(loc='upper right',fontsize=fntsz)
#    ax_5=plt.subplot(414,sharex=ax_40,sharey=ax_40)
    #       plt.setp(ax_5.get_xticklabels(), visible=False)
#    ax_5.errorbar(bins5, avg5, errors5, linestyle='None', marker='^', capsize=size_of_marker, color='orange',label=plot_name5)
#    ax_5.axhline(pvals5(50), color='black', lw=width_of_line)
#    ax_5.set_xlabel('Level (cm)',fontsize=fntsz)
#    ax_5.legend(loc='upper right',fontsize=fntsz)
    #  plt.errorbar(bins20, avg20, errors20, linestyle='None', marker='^', capsize=3, color='b', label=plot_name20)
    #  plt.errorbar(bins10, avg10, errors10, linestyle='None', marker='^', capsize=3, color='g', label=plot_name10)
    #  plt.errorbar(bins5, avg5, errors5, linestyle='None', marker='^', capsize=3, color='orange', label=plot_name5)
    #  plt.show()
